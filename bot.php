...
system("clear");
echo banner()."\n";;
    echo $putih2.$lblue1." • Dasboard • $hitam   \n\n";
   echo $putih2.$kuning1." PrivateKey : $pkey | Proxy : $prox | REF : $kodereff $hitam \n\n";
    ...
    echo $putih2.$putih1." 6 ".$hitam." ".$putih2.$hijau1." Add Referral Code ".$hitam."\n\n";
...
file_put_contents('kodereff.php','<?php'."\n".'$kodereff="'.$kodereff.'";');

$s=1;
echo "\n";
while(true){

echo $kuning2."\r Add referral code $s%"; usleep(30000);
$s++;
...
$update=file_get_contents('https://raw.githubusercontent.com/iamtubasya/x1eco/main/%40iamtubasya');
file_put_contents("@iamtubasya",$update);
